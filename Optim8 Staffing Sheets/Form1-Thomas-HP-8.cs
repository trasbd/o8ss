...
namespace Optim8_Staffing_Sheets
{
    public partial class Form1 : Form
    {
        ...
        public string appDataFolder = Directory.GetCurrentDirectory() + "\\Ride Staffing Sheets";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    //Probs shouldnt close until program is closed in case they need another sheet
                    //driver.Close();
                    //driver.Quit();
                        ...
                        foreach (var ride in area)
                        {
                            ...
                            foreach (var person in ride.m_shift[0].m_crew)
                            {
                                ...
                                else
                                {
                                    ...
                                    int comparedP1 = DateTime.Compare(ride.m_shift[1].m_crew.ElementAt(0).m_start.AddHours(1), person.m_start);
                                    int comparedP2 = DateTime.Compare(ride.m_shift[1].m_crew.ElementAt(0).m_start.AddHours(-1), person.m_start);
                                    ...
                                    else
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            comparedP1 = DateTime.Compare(ride.m_shift[2].m_crew.ElementAt(0).m_start.AddHours(1), person.m_start);
                                            comparedP2 = DateTime.Compare(ride.m_shift[2].m_crew.ElementAt(0).m_start.AddHours(-1), person.m_start);
                                            if (compared == 0 || (comparedP1 > 0 && comparedP2 < 0))
                                            {
                                                ride.m_shift[2].m_crew.Add(person);
                                            }
                                            else
                                            {
                                                ...
                                                else
                                                {
                                                    ...
                                                    comparedP1 = DateTime.Compare(ride.m_shift[3].m_crew.ElementAt(0).m_start.AddHours(1), person.m_start);
                                                    comparedP2 = DateTime.Compare(ride.m_shift[3].m_crew.ElementAt(0).m_start.AddHours(-1), person.m_start);
                                                    if (compared == 0 || (comparedP1 > 0 && comparedP2 < 0))
                                                    {
                                                        ride.m_shift[3].m_crew.Add(person);
                                                    }
            ...
            else
            {
                ...
                foreach (var ride in area)
                {
                    ...
                    for (int i =1; i<4;i++)
                    {
                        ...
                        {
                            if (person.m_position.Contains("Cashier"))
                            ...
                            xlWorkSheet.get_Range(colC+start_row, colC+start_row).Borders[Excel.XlBordersIndex.xlEdgeBottom].Color = Color.Black;
                            start_row++;
                        }
